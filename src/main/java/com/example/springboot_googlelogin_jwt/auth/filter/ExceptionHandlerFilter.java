...
import com.example.springboot_googlelogin_jwt.base.response.ExceptionResponse;
...
public class ExceptionHandlerFilter extends OncePerRequestFilter {
    ...
    private void setErrorResponse(HttpServletResponse response, String message, HttpStatus httpStatus){
